...
export const ANGLE_RATIONALE: Record<string, string> = {
  AK: "no in-state buyer; nearest is 1642 miles from the state's center",
  ...
  ID: "no in-state buyer; nearest is 394 miles from the state's center",
  ...
  MN: "no in-state buyer; nearest is 446 miles from the state's center",
  ...
  MT: "no in-state buyer; nearest is 566 miles from the state's center",
  NC: "has in-state buyers and one of the largest populations among them",
  ND: "no in-state buyer; nearest is 600 miles from the state's center",
  ...
  SD: "no in-state buyer; nearest is 428 miles from the state's center",
