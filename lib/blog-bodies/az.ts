...
export const AZ: PostBody = {
  ...
  metaDescription:
    "Nearly a fifth of Arizona is 65 or over, and supplies obtained through a government-covered program cannot be resold. That one condition settles more Arizona cupboards than anything else on this page.",
  ...
  sections: [
    {
      ...
      paragraphs: [
        "Supplies covered by a government program cannot be resold. That is not a preference and it is not something a buyer can waive for you — it is a condition on the supplies themselves, and it applies no matter how sealed the box is or how good the dates are.",
  ...
  faqs: [
    {
      ...
      a: "No. The label is not what matters. What matters is whether the supplies were obtained through a government-covered program, which cannot be resold, and whether the box is still factory-sealed. Nobody asks you to account for how you came to have them beyond that.",
    },
    {
      q: "Some of what I have came through a government program and some I bought outright. What then?",
