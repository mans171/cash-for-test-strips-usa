...
export const TN: PostBody = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Supplies obtained through a government-covered program cannot be resold, and no condition or brand changes that. This is a restriction on the supplies themselves rather than a judgement about the seller.",
        "Supplies bought retail or received through private insurance are not affected. Nor is a pharmacy label with your own name on it — that is entirely ordinary and appears on most of what gets sold. The question is which program paid, not what is printed on the sticker.",
