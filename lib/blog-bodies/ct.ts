...
export const CT: PostBody = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Not obtained through a government program. Supplies paid for that way cannot legally be resold. Private insurance or out of pocket is fine, and a pharmacy label carrying your name makes no difference.",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "No. Supplies paid for by a government program cannot be resold. Anything you received through private insurance or paid for yourself is fine.",
    },
    {
