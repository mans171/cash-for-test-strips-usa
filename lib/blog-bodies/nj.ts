...
export const NJ: PostBody = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Not obtained through a government-funded program. Supplies paid for that way cannot legally be resold. Private insurance or out of pocket is fine, and a pharmacy label with your name on it makes no difference.",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "No. Supplies obtained through a government-covered program cannot be resold. Anything received through private insurance or paid for yourself is fine.",
    },
    {
