  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Not covered by a government programme. Supplies paid for that way cannot legally be resold. Private insurance or paid for yourself is fine, and a pharmacy label with your name on it makes no difference.",
