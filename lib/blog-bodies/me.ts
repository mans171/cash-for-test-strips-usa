  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Then the source. Supplies obtained through a government-covered program cannot be resold. In a state where nearly a quarter of residents are 65 or over this is worth establishing early, and the pharmacy that filled the prescriptions can usually confirm it. A pharmacy label with a name on it, by contrast, changes nothing and does not need removing.",
