  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "The funding route second. Supplies obtained through a government-covered program cannot be resold. Retail purchases and private insurance are fine. A pharmacy label with your own name on it changes nothing and is not something anyone will query.",
  ...
  faqs: [
    {
      ...
      a: "Yes, and for Portland-area readers it is the most practical option available. The Vancouver listing is across the Columbia from Portland. The conditions are identical to those anywhere else: sealed boxes, not obtained through a government-covered program, and enough shelf life left on any strips.",
    },
    {
    ...
    {
      q: "I bought Libre sensors while traveling. Can I sell those?",
