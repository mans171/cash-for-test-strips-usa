  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "It cannot have been bought through a government-covered program. Supplies paid for that way cannot legally be resold. If yours came through your own insurance or you paid retail, that is fine — and a pharmacy label with your name on it does not affect anything.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "We do not buy opened boxes, anything bought through a government-covered program, or expired supplies other than the two exceptions above. If you are unsure which category yours falls into, that is a phone call, not a guess.",
      ],
    },
  ],
  ...
  faqs: [
    {
      ...
      a: "Not through this directory — there is no buyer listed anywhere in Montana, and the nearest is roughly 566 miles from the center of the state. Mail-in is the honest answer here. If that changes and a buyer sets up in Billings or Missoula, they will appear on the Montana page.",
    },
    {
    ...
    },
    {
      ...
      a: "That is fine and does not affect the sale. What matters is that the box is sealed and that the supplies were not obtained through a government-covered program. You are not asked to explain how you came to have them.",
    },
    {
