...
export const WI: PostBody = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Supplies obtained through a government-covered program cannot be resold. This is the check that disqualifies a box even when everything else about it is perfect, so it is worth doing before you go to the trouble of packing anything.",
        ...
        "A pharmacy label with a name printed on it is not a problem and does not need removing. People assume it is the giveaway that stops a sale. It is not — it says nothing about which program paid for the prescription.",
