...
export const WI: PostBody = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Supplies obtained through a government-covered programme cannot be resold. This is the check that disqualifies a box even when everything else about it is perfect, so it is worth doing before you go to the trouble of packing anything.",
