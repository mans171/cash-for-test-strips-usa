...
export const CO: PostBody = {
  ...
  faqs: [
    ...
    {
      q: "My supplies came through a government program. Can I still sell them?",
      a: "No. Supplies obtained through a government-covered program cannot be resold, and that applies in Colorado as it does everywhere else. If you bought them retail or they came through private insurance, that is a different situation — and a pharmacy label with your own name printed on it does not affect anything either way.",
    },
  ],
}
