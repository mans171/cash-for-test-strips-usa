  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "And one exclusion that has nothing to do with condition: supplies obtained through a government-covered program cannot be resold. A pharmacy label with your name on it is fine — that is a different question from who paid the bill.",
      ],
    },
    {
