        ...
        <>
          {mailIn && (
            <div className="mb-12">
              ...
              <p className="text-gray-800 font-semibold max-w-2xl mb-3 text-sm leading-relaxed">
              ...
              <Link href="/mail-in-kit" className={`${btnPrimary} mb-6`}>
                Start a mail-in kit from {label}
              </Link>
